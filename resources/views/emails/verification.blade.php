    ...
    <div class="row">
        <div class="email-container">
            ...
            <div class="row username">
                <h4>hello <strong>{{$data['name']}}</strong></h4>
            </div>
            <div class="row approve d-flex flex-row justify-content-center">
                <div style="margin-bottom: 25px; width: 100%">
                    <p class="text-center font-weight-light main-color" style="margin: auto; font-family: 'Almarai', sans-serif;">  Thanks for your Registration  <span class="app-color"> </span>   , please verify your Account  </p>
                </div>
            </div>
            ...
            <div class="">
                <div class="email-white-space">
                    ...
                    <div class="code">
                        <a type="submit" href="{{url('verification/'.$data->id)}}" class="btn">Click here to verify Your Account</a>.
